...
<aside class="main-sidebar sidebar-dark-primary navbar-navy elevation-4">
  ...
  <a href="index3.html" class="brand-link bg-navy">
    <img src="{{asset('img/cours-info2.jpg')}}" class="img-circle elevation-1 mr-1 text-white text-bold p-1" alt="GIPAN" style="border-right: solid 3px rgb(51, 51, 51); opacity: .7;" width="43px">
